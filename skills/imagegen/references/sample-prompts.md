...
```
Use case: comic-character-sheet
Asset type: recurring comic character reference sheet
Primary request: reference sheet for "Asha", a teenage inventor who will appear across a short sci-fi comic
Character anchors: heart-shaped face; short curly black hair with the left temple shaved; round yellow goggles; rust-orange scarf; canvas tool satchel
Scene/backdrop: plain white studio background
Subject: front view, 3/4 view, side profile, back view, and a four-expression row
Style/medium: clean colored comic character sheet
Composition/framing: orderly grid with full-body turnarounds and a small expression strip
Color palette: teal jacket, rust-orange scarf, charcoal pants, warm brown skin
Constraints: keep costume details identical in every view; neutral pose for turnarounds; no background clutter; no watermark
```

### comic-panel
```
Use case: comic-panel
Asset type: single comic splash panel
Primary request: a lone courier steps onto a rain-soaked rooftop and sees the city power grid fail
Character anchors: lean build; orange visor; dark hooded jacket with a white stripe on one sleeve; hard-shell delivery case
Scene/backdrop: dense futuristic skyline, heavy rain, distant electrical failures
Subject: courier pausing mid-step on the rooftop edge
Style/medium: dramatic manga-inspired comic art
Composition/framing: tall splash panel, low-angle hero shot
Lighting/mood: electric blue night lighting, urgent mood
Constraints: clear silhouette; one decisive action beat; no speech bubbles; no watermark
```

### comic-page
```
Use case: comic-page
Asset type: 4-panel comic page
Primary request: a student realizes her homemade robot actually understands her
Character anchors: student with messy short black hair, oversized yellow sweater, bandaged thumb; small mint-green robot with a round screen face and one dented corner
Panel plan: 4 panels, left-to-right top-to-bottom reading order; Panel 1 robot fails again; Panel 2 student slumps; Panel 3 robot offers the repaired sketchbook; Panel 4 shared smile and glowing eyes
Scene/backdrop: cramped bedroom workshop across all panels
Subject: the student and robot in a single evening scene
Style/medium: warm clean-line comic page
Composition/framing: clear gutters and panel borders, varied but readable framing
Lighting/mood: cozy desk-lamp lighting, hopeful ending
Constraints: consistent character design in every panel; keep dialogue minimal or leave balloons blank; no watermark
```

### knowledge-comic
```
Use case: knowledge-comic
Asset type: educational comic page
Primary request: explain how gradient descent works to beginners
Panel plan: 5 panels, top-to-bottom reading order; concept introduction; ball-on-hill metaphor; wrong step versus better step; repeated descent; convergence
Scene/backdrop: classroom-whiteboard meets abstract landscape metaphor
Subject: beginner-friendly explainer visuals and one guide character
Style/medium: clear educational manga page
Composition/framing: clean explanatory layouts with readable panel flow
Text (verbatim): "Gradient Descent", "Start", "Lower Loss", "Repeat"
Constraints: one core concept per panel; blend explanation with visual metaphor; keep labels exact; no watermark
```
